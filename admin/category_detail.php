        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                   <center>  
				   <h3 style="color:#00008B">Insert Category Details</h3>
				   </center>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
...
<form action="category_add.php" method="post" enctype="multipart/form-data" style="padding: 10px;color:#31708f; font-size:20px;">
...
<?php
$db=mysqli_query($con,"select *from category_table order by Category_id");
