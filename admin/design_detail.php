        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                   <center>  
				   <h3 style="color:#00008B">Insert Design Details</h3>
				   </center>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
...
<form action="design_add.php" method="post" enctype="multipart/form-data" style="padding: 10px;color:#31708f; font-size:20px;">
	...
	<tr>
		<td>Size: </td>
		<td><input type="number" min="0" name="r4" required="" class="form-control" /></td>
	</tr>
	<tr>
		<td>Design Cost: </td>
		<td><input type="number" min="0" name="r5" required="" class="form-control" /></td>
	</tr>
	<tr>
			<td>Image:</td>
			<td>
 ...
 <br><br> 
   ...
   <div class="row">
                    <div class="col-lg-12">
                   <center>  
				   <h3 style="color:#006400">All Designs:</h3>
				   </center>   
                    </div>
                </div>
