        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                   <center>  
				   <h3 style="color:#8B0000">Update Product Category Deatails</h3>
				   </center>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
...
<?php
	$id=$_GET["x"];
	$db=mysqli_query($con,"select * from pro_category_table where Category_id='$id'");
	$rc=mysqli_num_rows($db);
	$row=mysqli_fetch_array($db);
?>					

            <form action="p_category_update.php" method="post" enctype="multipart/form-data" style="padding:10px;color:#31708f; font-size:20px;">
<strong ><table align="center">
	<tr>
  	...
  	<tr></strong>
		...
		<td ><a href="p_category_detail.php"><input type="button" value="cancle" class="btn btn-warning" /></a></td>
	</tr>
</table>
                        </form>
						</div>
...
<?php
$id=$_GET["x"];
$db=mysqli_query($con,"select *from pro_category_table");
$rc=mysqli_num_rows($db);
  ?>				
